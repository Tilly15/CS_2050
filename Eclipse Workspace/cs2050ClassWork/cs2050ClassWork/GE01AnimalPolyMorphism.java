...
public class GE01AnimalPolyMorphism
{
	...
	public static void main(String[] args)
	{
		try
		{
			AnimalD[] animals = readAnimalsFromFile("Animals.txt");

			// Now demonstrate the power of polymorphism!
			for (int i = 0; i < animals.length; i++)
			{
				System.out.println();
				if (animals[i] instanceof BearD)
				{
					System.out.println("Animal[" + i + "] is a Bear");
				} else if (animals[i] instanceof ElephantD)
				{
					System.out.println("Animal[" + i + "] is an Elephant");
				} else if (animals[i] instanceof MonkeyD)
				{
					System.out.println("Animal[" + i + "] is a Monkey");
				} else if (animals[i] instanceof SlothD)
				{
	 ...
	 */
	public static AnimalD[] readAnimalsFromFile(String filename) throws FileNotFoundException
	{
		...
		try
		{
			...
			AnimalD[] animals = new AnimalD[numAnimals];
			...
			for (int i = 0; i < animals.length; i++)
			{
				...
				{
				case "Bear":
					animals[i] = new BearD(name, food, weight, sleep, location);
					break;
				case "Elephant":
					animals[i] = new ElephantD(name, food, weight, sleep, location);
					break;
				case "Monkey":
					animals[i] = new MonkeyD(name, food, weight, sleep, location);
					break;
				case "Sloth":
					animals[i] = new SlothD(name, food, weight, sleep, location);
					break;
				default:
...
class AnimalD
{
	...
	public AnimalD(String name, String food, int weight, int sleep, String location)
	{
		this.name = name;
		this.food = food;
		this.weight = weight;
...
class BearD extends AnimalD
{
	public BearD(String name, String food, int weight, int sleep, String location)
	{
...
class ElephantD extends AnimalD
{
	public ElephantD(String name, String food, int weight, int sleep, String location)
	{
		super(name, food, weight, sleep, location);
	}
...
class MonkeyD extends AnimalD
{
	public MonkeyD(String name, String food, int weight, int sleep, String location)
	{
		super(name, food, weight, sleep, location);
	}
...
class SlothD extends AnimalD
{
	public SlothD(String name, String food, int weight, int sleep, String location)
	{
		super(name, food, weight, sleep, location);
	}
